...
import '../custom_widgets/verticalProductsList.dart';
  ...
  Widget build(BuildContext context) {
    return  Scaffold(
      appBar: AppBar(
        ...
        centerTitle: true,
        title: Text('مقترحه لك', style: TextStyle( fontSize: 20.spMin,
      ...
      body: Directionality(
        ...
        child: Column(
          children: [
            ...
            const Expanded(child: VerticalProductsList(color: Colors.white))
          ],
        ),
      ),
    );
